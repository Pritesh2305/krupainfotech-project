...
{
    public class mstcityRepository : ImstcityRepository
    {
        private Mydbcontext _context;
        public mstcityRepository(Mydbcontext context)
        {
            _context = context;
        }
        public ResultDto<RidResponse> Insert(mstcityRequest viewModel)
        {
            ...
            try
            {
                ...
                var response = _context.Database.ExecuteSqlRaw("execute usp_mstcity_add  @p_json," +
        ...
        public ResultDto<RidResponse> Update(mstcityRequest viewModel)
        {
            ...
            try
            {
                ...
                var response = _context.Database.ExecuteSqlRaw("execute usp_mstcity_update @p_json," +
                                                                " @p_retrid OUTPUT,@p_retval OUTPUT,@p_reterr OUTPUT",
                                                                in_para1, out_para1, out_para2, out_para3);
        ...
        public ResultDto<RidResponse> Delete(DelRequest viewModel)
        {
            ...
            try
            {
                ...
                var response = _context.Database.ExecuteSqlRaw("execute usp_mstcity_delete @p_json," +
                                                                " @p_retrid OUTPUT,@p_retval OUTPUT,@p_reterr OUTPUT",
                                                                in_para1, out_para1, out_para2, out_para3);
        ...
        {
            ResultDto<IEnumerable<Dbmstcity?>> res = new ResultDto<IEnumerable<Dbmstcity?>>()
            {
                ISuccess = false,
                Data = null,
                Errors = new List<string>()
            ...
            try
            {
                var response =  _context.mstcity.FromSqlRaw("execute usp_mstcitydetail_list");
                res.ISuccess = true;
                res.Data = response;
                return res;
            }
            ...
            {
                res.Errors.Add($"Error Occured in GetDetaillist Reposity : {ex.Message.ToString()}");
                return res; 
            }
        ...
        public ResultDto<IEnumerable<Dbmstcity?>> GetAllDetails()
        {
            ...
            try
            {
                var response = _context.mstcity.FromSqlRaw("execute usp_mstcitydetail_all");
                res.ISuccess = true;
                res.Data = response;
                return res;
            }
            ...
            {
                res.Errors.Add($"Error Occured in GetDetailsAll Reposity : {ex.Message.ToString()}");
                return res;
            }
        ...
        {
            ResultDto<IEnumerable<Comstcity?>> res = new ResultDto<IEnumerable<Comstcity?>>()
            {
                ISuccess = false,
                Data = null,
                Errors = new List<string>()
            ...
            try
            {
                var response = _context.comstcity.FromSqlRaw("execute usp_mstcity_list");
                res.ISuccess = true;
                res.Data = response;
                return res;
            }
            ...
            {
                res.Errors.Add($"Error Occured in Getlist Reposity : {ex.Message.ToString()}");
                return res;
            }
        ...
        public ResultDto<IEnumerable<Comstcity?>> GetAll()
        {
            ...
            try
            {
                var response = _context.comstcity.FromSqlRaw("execute usp_mstcity_all");
                res.ISuccess = true;
                res.Data = response;
                return res;
            }
            ...
            {
                res.Errors.Add($"Error Occured in GetAll Reposity : {ex.Message.ToString()}");
                return res;
            }
        ...
        {
            ResultDto<Comstcity?> res = new ResultDto<Comstcity?>()
            {
                ISuccess = false,
                Data = null,
                Errors = new List<string>()
            ...
            try
            {
                var response = _context.comstcity.FromSqlRaw("execute usp_mstcity_select @p_rid", new SqlParameter("@p_rid", Id)).AsEnumerable().FirstOrDefault();
                res.ISuccess = true;
                res.Data = response;
                return res;
            }
            ...
            {
                res.Errors.Add($"Error Occured in GetById Reposity : {ex.Message.ToString()}");
                return res;
            }
