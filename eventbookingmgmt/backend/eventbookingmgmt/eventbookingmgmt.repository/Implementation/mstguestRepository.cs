...
{
    public class mstguestRepository : ImstguestRepository
    {
        private Mydbcontext _context;
        public mstguestRepository(Mydbcontext context)
        {
            _context = context;
        }
        public ResultDto<RidResponse> Insert(mstguestRequest viewModel)
        {
            ...
            try
            {
                ...
                var response = _context.Database.ExecuteSqlRaw("execute usp_mstguest_add  @p_json," +
        ...
        public ResultDto<RidResponse> Update(mstguestRequest viewModel)
        {
            ...
            try
            {
                ...
                var response = _context.Database.ExecuteSqlRaw("execute usp_mstguest_update @p_json," +
                                                                " @p_retrid OUTPUT,@p_retval OUTPUT,@p_reterr OUTPUT",
                                                                in_para1, out_para1, out_para2, out_para3);
        ...
        public ResultDto<RidResponse> Delete(DelRequest viewModel)
        {
            ...
            try
            {
                ...
                var response = _context.Database.ExecuteSqlRaw("execute usp_mstguest_delete @p_json," +
                                                                " @p_retrid OUTPUT,@p_retval OUTPUT,@p_reterr OUTPUT",
                                                                in_para1, out_para1, out_para2, out_para3);
        ...
        public ResultDto<IEnumerable<Dbmstguest?>> GetAllDetails()
        {
            var resp = new ResultDto<IEnumerable<Dbmstguest?>>()
            {
                ISuccess = false,
                Data = null,
                Errors = new List<string>()
            ...
            try
            {
                IEnumerable<Dbmstguest?> response = _context.mstguest.FromSqlRaw("execute usp_mstguest_getalldetails");
                resp.ISuccess = true;
        ...
        public ResultDto<IEnumerable<Comstguest?>> GetList()
        {
            var resp = new ResultDto<IEnumerable<Comstguest?>>()
            {
                ISuccess = false,
                Data = null,
                Errors = new List<string>()
            ...
            try
            {
                IEnumerable<Comstguest?> response = _context.comstguest.FromSqlRaw("execute usp_mstguest_getlist");
                resp.ISuccess = true;
                if (response.Count() > 0) resp.Data = response;
                return resp;
            }
        ...
        public ResultDto<Dbmstguest?> GetById(Int64 Id)
        {
            var resp = new ResultDto<Dbmstguest?>()
            {
                ISuccess = false,
                Data = null,
                Errors = new List<string>()
            ...
            try
            {
                Dbmstguest? response = _context.mstguest.FromSqlRaw("execute usp_mstguest_getbyid @p_rid", new SqlParameter("@p_rid", Id)).AsEnumerable().FirstOrDefault();
                resp.ISuccess = true;
                resp.Data = response;
                return resp;
            }
