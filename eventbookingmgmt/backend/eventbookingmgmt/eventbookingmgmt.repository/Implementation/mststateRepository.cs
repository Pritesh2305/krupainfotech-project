...
{
    public class mststateRepository : ImststateRepository
    {
        private Mydbcontext _context;
        public mststateRepository(Mydbcontext context)
        {
            _context = context;
        }
        public ResultDto<RidResponse> Insert(mststateRequest viewModel)
        {
            ...
            try
            {
                ...
                var response = _context.Database.ExecuteSqlRaw("execute usp_mststate_add  @p_json," +
        ...
        public ResultDto<RidResponse> Update(mststateRequest viewModel)
        {
            ...
            try
            {
                ...
                var response = _context.Database.ExecuteSqlRaw("execute usp_mststate_update @p_json," +
                                                                " @p_retrid OUTPUT,@p_retval OUTPUT,@p_reterr OUTPUT",
                                                                in_para1, out_para1, out_para2, out_para3);
        ...
        public ResultDto<RidResponse> Delete(DelRequest viewModel)
        {
            ...
            try
            {
                ...
                var response = _context.Database.ExecuteSqlRaw("execute usp_mststate_delete @p_json," +
                                                                " @p_retrid OUTPUT,@p_retval OUTPUT,@p_reterr OUTPUT",
                                                                in_para1, out_para1, out_para2, out_para3);
        ...
        public ResultDto<IEnumerable<Dbmststate?>> GetAllDetails()
        {
            var resp = new ResultDto<IEnumerable<Dbmststate?>>()
            {
                ISuccess = false,
                Data = null,
                Errors = new List<string>()
            ...
            try
            {
                IEnumerable<Dbmststate?> response = _context.mststate.FromSqlRaw("execute usp_mststate_getalldetails");
                resp.ISuccess = true;
        ...
        public ResultDto<IEnumerable<Comststate?>> GetList()
        {
            var resp = new ResultDto<IEnumerable<Comststate?>>()
            {
                ISuccess = false,
                Data = null,
                Errors = new List<string>()
            ...
            try
            {
                IEnumerable<Comststate?> response = _context.comststate.FromSqlRaw("execute usp_mststate_getlist");
                resp.ISuccess = true;
                if (response.Count() > 0) resp.Data = response;
                return resp;
            }
        ...
        public ResultDto<Dbmststate?> GetById(Int64 Id)
        {
            var resp = new ResultDto<Dbmststate?>()
            {
                ISuccess = false,
                Data = null,
                Errors = new List<string>()
            ...
            try
            {
                Dbmststate? response = _context.mststate.FromSqlRaw("execute usp_mststate_getbyid @p_rid", new SqlParameter("@p_rid", Id)).AsEnumerable().FirstOrDefault();
                resp.ISuccess = true;
                resp.Data = response;
                return resp;
            }
