...
{
    public class mstcountryRepository : ImstcountryRepository
    {
        private Mydbcontext _context;
        public mstcountryRepository(Mydbcontext context)
        {
            _context = context;
        }
        public ResultDto<RidResponse> Insert(mstcountryRequest viewModel)
        {
            ...
            try
            {
                ...
                var response = _context.Database.ExecuteSqlRaw("execute usp_mstcountry_add  @p_json," +
        ...
        public ResultDto<RidResponse> Update(mstcountryRequest viewModel)
        {
            ...
            try
            {
                ...
                var response = _context.Database.ExecuteSqlRaw("execute usp_mstcountry_update @p_json," +
                                                                " @p_retrid OUTPUT,@p_retval OUTPUT,@p_reterr OUTPUT",
                                                                in_para1, out_para1, out_para2, out_para3);
        ...
        public ResultDto<RidResponse> Delete(DelRequest viewModel)
        {
            ...
            try
            {
                ...
                var response = _context.Database.ExecuteSqlRaw("execute usp_mstcountry_delete @p_json," +
                                                                " @p_retrid OUTPUT,@p_retval OUTPUT,@p_reterr OUTPUT",
                                                                in_para1, out_para1, out_para2, out_para3);
        ...
        public ResultDto<IEnumerable<Dbmstcountry?>> GetAllDetails()
        {
            var resp = new ResultDto<IEnumerable<Dbmstcountry?>>()
            {
                ISuccess = false,
                Data = null,
                Errors = new List<string>()
            ...
            try
            {
                IEnumerable<Dbmstcountry?> response = _context.mstcountry.FromSqlRaw("execute usp_mstcountry_getalldetails");
                resp.ISuccess = true;
        ...
        public ResultDto<IEnumerable<Comstcountry?>> GetList()
        {
            var resp = new ResultDto<IEnumerable<Comstcountry?>>()
            {
                ISuccess = false,
                Data = null,
                Errors = new List<string>()
            ...
            try
            {
                IEnumerable<Comstcountry?> response = _context.comstcountry.FromSqlRaw("execute usp_mstcountry_getlist");
                resp.ISuccess = true;
                if (response.Count() > 0) resp.Data = response;
                return resp;
            }
        ...
        public ResultDto<Dbmstcountry?> GetById(Int64 Id)
        {
            var resp = new ResultDto<Dbmstcountry?>()
            {
                ISuccess = false,
                Data = null,
                Errors = new List<string>()
            ...
            try
            {
                Dbmstcountry? response = _context.mstcountry.FromSqlRaw("execute usp_mstcountry_getbyid @p_rid", new SqlParameter("@p_rid", Id)).AsEnumerable().FirstOrDefault();
                resp.ISuccess = true;
                resp.Data = response;
                return resp;
            }
